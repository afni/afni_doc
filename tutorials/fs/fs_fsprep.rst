...
.. list-table:: Images alternating between input/output of ``recon-all`` for various dset properties. Descriptions are given as follows: each of the 3 matrix (mat) dimensions can be even (E) or odd (O); voxels (vox) can be isotropic (iso) or anisotropic (aniso), and be of various sizes.
   :header-rows: 1
   :widths: 50 50 

   * - Case 1, "good": mat=EEE, vox=iso (1mm)
     - Case 2, "bad": mat=EEO, vox=iso (1mm)
   * - .. image:: media/fs_fsprep/movie_anat_01_eee_iso1.gif
          :width: 100%   
          :align: center
     - .. image:: media/fs_fsprep/movie_anat_02_eeo_iso1.gif
          :width: 100%   
          :align: center
...
.. list-table:: 
   ...
   * - Case 3, "bad": mat=EEE, vox=aniso (1x0.94x0.94mm)
     - Case 4, "bad": mat=EEO, vox=aniso (1x0.94x0.94mm)
   * - .. image:: media/fs_fsprep/movie_anat_03_eee_aniso.gif
          :width: 100%   
          :align: center
...
.. list-table:: 
   ...
   * - Case 5, "bad": mat=EEE, vox=iso (0.90mm)
     - Case 6, "bad": mat=OOE, vox=iso (1mm)
   * - .. image:: media/fs_fsprep/movie_anat_06_eee_iso09.gif
          :width: 100%   
          :align: center
     - .. image:: media/fs_fsprep/movie_anat_13_ooe_iso1.gif
          :width: 100%   
          :align: center
...
.. literalinclude:: media/fs_fsprep/check_fsprep.txt
   :language: none
...
.. literalinclude:: media/fs_fsprep/check_fix_fsprep.txt
   :language: none
...
.. literalinclude:: media/fs_fsprep/ex_a.tcsh
   :language: tcsh
