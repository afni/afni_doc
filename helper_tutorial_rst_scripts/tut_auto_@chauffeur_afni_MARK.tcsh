...
#:SUBSECTION: **Ex. 0**: 3D anatomical volume
...
#:SUBSECTION:  **Ex. 1**: 3D anatomical volume
...
#:SUBSECTION:  **Ex. 2**: 3D anatomical volume, olay mask
...
#:SUBSECTION:  **Ex. 3**: threshold stats voxelwise, view effects
...
#:IMAGE: Example 3
    QC/ca003_*.axi.png QC/ca003_*.cor.png
    QC/ca003_*.sag.png
...
#:SUBSECTION:  **Ex. 4**: threshold stats voxelwise, view effects, II
...
#:IMAGE: Example 4
    QC/ca004_*.axi.png QC/ca004_*.cor.png
    QC/ca004_*.sag.png
...
#:SUBSECTION:  **Ex. 5**: threshold stats voxelwise, view effects, III
...
#:IMAGE: Example 5
    QC/ca005_*.axi.png QC/ca005_*.cor.png
    QC/ca005_*.sag.png
...
#:SUBSECTION:  **Ex. 6**: threshold stats voxelwise + clusterize, view effects
...
#:IMAGE: Example 6
    QC/ca006_*.axi.png QC/ca006_*.cor.png
    QC/ca006_*.sag.png
...
#:SUBSECTION:  **Ex. 7**: threshold stats voxelwise + clusterize, view effects, II
...
#:IMAGE: Example 7
    QC/ca007_*.axi.png QC/ca007_*.cor.png
    QC/ca007_*.sag.png
...
#:SUBSECTION:  **Ex. 8**: view ROIs (here, cluster maps)
...
#:IMAGE: Example 8
    QC/ca008_*.axi.png QC/ca008_*.cor.png
    QC/ca008_*.sag.png
...
#:SUBSECTION:  **Ex. 9**: check alignment with edge view
...
#:IMAGE: Example 9
    QC/ca009_*.axi.png QC/ca009_*.cor.png
    QC/ca009_*.sag.png
