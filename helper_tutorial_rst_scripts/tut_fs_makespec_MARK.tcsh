...
#:TITLE: More useful outputs from @SUMA_Make_Spec_FS
...
#:SECTION: The renumbered (REN) atlas dsets
...
#:SECTION: The fs*.nii.gz mask dsets
...
* **qc_02\*.jpg:** the overlay is a set of tissues, like a
  ...
  #:IMAGE: 
    for_fs_makespec/qc_02_*.jpg


* **qc_03\*.jpg:** the GM only

  #:IMAGE: 
    for_fs_makespec/qc_03_*.jpg


* **qc_04\*.jpg:** the WM only

  #:IMAGE: 
    for_fs_makespec/qc_04_*.jpg
...
* **qc_05\*.jpg:** the overlay is the "2000" atlas parcellation (from
  ...
  #:IMAGE: 
    for_fs_makespec/qc_05_*.jpg

TEXTBLOCK

#:SECTION: ROI, tissue and mask quantities (stats\*.1D files)
...
#:INCLUDE:  for_fs_makespec/stats_fs_segs_2000_sub-004.1D
   :language: none
   :lines: 1-10

For ``stats_fs_rois_2000_*.1D``, describing the ROI parcellations:

#:INCLUDE:  for_fs_makespec/stats_fs_rois_2000_sub-004.1D
   :language: none
   :lines: 1-10
