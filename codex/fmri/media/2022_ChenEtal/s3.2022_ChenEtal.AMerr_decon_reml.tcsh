...
3dDeconvolve                                                                 \
    ...
    -num_stimts      12                                                      \
    -stim_times      1 ${stimdir}/Con_corr_${subj}-${session}.1D 'GAM'       \
    ...
    -stim_times_AM2  4 ${stimdir}/Incon_com_${subj}-${session}AM.1D 'GAM'    \
    ...
    -allzero_OK                                                              \
    -num_glt         2                                                       \
    -gltsym          'SYM: +Incong_com[0] -Incong_cor[0]'                    \
    -glt_label       1 Incong_com_VS_Incong_cor0                             \
    -gltsym          'SYM: +Incong_com[1] -Incong_cor[1]'                    \
    -glt_label       2 Incong_com_VS_Incong_cor1                             \
