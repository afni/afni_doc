...
3dDeconvolve                                                                 \
    ...
    -num_stimts     12                                                       \
    -stim_times_IM  1 ${stimdir}/Con_corr_${subj}-${session}.1D 'GAM'        \
    -stim_label     1 Cong_cor                                               \
    -stim_times_IM  2 ${stimdir}/Incon_corr_${subj}-${session}.1D 'GAM'      \
    -stim_label     2 Incong_cor                                             \
    -stim_times     3 ${stimdir}/Con_com_${subj}-${session}.1D 'GAM'         \
    -stim_label     3 Cong_com                                               \
