...
# [PT: 13 May 2019] updated to deal with subprocess returning 'bytes'
# type stdout; that simply gets converted to string.
#
# [PT: 27 Dec 2021] Fix reference link; add comment to top of
# generated *.rst file (so unassuming readers know how it came about)
...
.. comment:
   ...
   This file was auto-generated by:
     afni_doc/python_help_scripts/make_file_of_all_afni_cbars.py
...
examples :ref:`here <tut_auto_@chauffeur_afni>`), you also use that
option, e.g.,:
